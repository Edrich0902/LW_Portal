...
import {sbCreateSocialMedia, sbDeleteSocialMedia, sbUpdateSocialMedia} from "../../services/social-media-service";
...
export const deleteSocialMedia = async (socialMedia: SocialMedia) => {
    socialMediaModalStore.update((state) => ({
        ...state,
        status: Status.LOADING
    }));
